...
TODO: Remove the mess stuff from the several pics of the same the scene.
"""
...
def get_average(pixels):
    ...
    for pixel in pixels:
        ...
        pixel_num += 1
    return [total_red // pixel_num, total_green // pixel_num, total_blue // pixel_num]
...
def get_best_pixel(pixels):
    ...
    for pixel in pixels:
        ...
        dist_d[pixel] = dist
    sort = sorted(dist_d.items(), key=lambda ele: ele[1])
    return sort[0][0]
